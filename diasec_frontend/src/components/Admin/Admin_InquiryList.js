        ...
        <div className='bg-gray-50 w-full min-h-screen py-12'>
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    ...
                    {/* 날짜 */}
                    <div>
                        <button className="w-[52px] h-[32px] border bg-white text-sm" onClick={handleAllPeriod}>전체</button>
                        <button className="w-[52px] h-[32px] border bg-white text-sm" onClick={handleToday}>오늘</button>
                        <button className="w-[52px] h-[32px] border bg-white text-sm" onClick={() => handleRangeClick(1)}>1개월</button>
                        <button className="w-[52px] h-[32px] border bg-white text-sm" onClick={() => handleRangeClick(3)}>3개월</button>
